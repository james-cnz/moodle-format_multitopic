...
2. Log in as an admin, and load the Dashboard, to update plugins

3. Site administration > Appearance > Additional HTML > Within HEAD: Copy and paste styles from README_styles.css (customising appropriately)
